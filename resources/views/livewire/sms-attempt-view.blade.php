                ...
                <div class="container mx-auto p-4">
                    ...
                    <form wire:submit.prevent="importSms" enctype="multipart/form-data" class="mb-4 bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
                        <div class="flex flex-col md:flex-row items-center">
                            <input type="file" wire:model="file" required class="block w-full md:w-auto text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100 dark:file:bg-blue-700 dark:file:text-blue-50 dark:hover:file:bg-blue-600">
                            <button type="submit" wire:loading.attr="disabled" wire:target="importSms" class="mt-2 md:mt-0 md:ml-4 px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-700 dark:bg-blue-600 dark:hover:bg-blue-500">
